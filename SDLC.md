...
```bash
lubuntu-lark-neuroshell_VERSION_ARCH/
├── DEBIAN/
│   ├── control                         # (Dynamically generated by build script)
...
Run the automated build script to compile, stage, and package the entire ecosystem:
